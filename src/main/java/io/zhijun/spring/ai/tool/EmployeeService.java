package io.zhijun.spring.ai.tool;
...
public class EmployeeService {
    ...
    void init() {
        ...
        employeeTable.put("emp1002", new Employee("emp1002", "Jane Smith", "jane.smith@example.com"));
        employeeTable.put("emp1003", new Employee("emp1003", "James", "james@example.com"));

        employeeLeavesTable.put(LocalDate.now(), new java.util.ArrayList<>(List.of("emp1001", "emp1003")));
        employeeLeavesTable.put(LocalDate.of(2025, 1, 1), new java.util.ArrayList<>(List.of("emp1001", "emp1002")));
        employeeLeavesTable.put(LocalDate.of(2025, 1, 2), new java.util.ArrayList<>(List.of("emp1002", "emp1003")));
    }
